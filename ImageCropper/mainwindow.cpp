...
void MainWindow::on_actionOpen_triggered()
{
    ...
    if (fileName != "")
    {
        ...
        if (!newPix.isNull())
        {
            ...
            {
                QMessageBox::warning(this, tr("Invalid Size"), tr("Size of the image must be bigger than 200x200."));
                return;
            }
            ...
            QMessageBox::warning(this, tr("Invalid Image"), tr("You tried loading an invalid file."));
    }
}
