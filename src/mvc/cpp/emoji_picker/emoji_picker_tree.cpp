...
const EmojiCategory &EmojiPickerItem::category() const { return itemCategory; }
...
void EmojiPickerModel::clear() { removeRows(0, rowCount()); }
...
EmojiPickerTree::EmojiPickerTree(QWidget *parent) : QTreeView(parent) {
