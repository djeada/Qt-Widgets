...
CryptoRankingModel::CryptoRankingModel(QObject *parent)
    : QAbstractTableModel(parent) {}

CryptoRankingModel::CryptoRankingModel(const QList<CryptoRankingData> &data,
                                       QObject *parent)
    : QAbstractTableModel(parent) {
  modelData = data;
}
...
QVariant CryptoRankingModel::headerData(int section,
...
void CryptoRankingModel::clear() { modelData.clear(); }
