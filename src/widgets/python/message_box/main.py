...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def show_message_box(self):
        ...
        message_box.setText('The most recent modifications are not saved.\nWould you like to save them?')
        ...
        if result == QtWidgets.QMessageBox.StandardButton.Save:
            QtWidgets.QMessageBox.information(None, "My Application", "Save clicked.").show()
        elif result == QtWidgets.QMessageBox.StandardButton.Discard:
            QtWidgets.QMessageBox.information(None, "My Application", "Discard clicked.").show()
        elif result == QtWidgets.QMessageBox.StandardButton.Cancel:
            QtWidgets.QMessageBox.information(None, "My Application", "Cancel clicked.").show()
        else:
            pass
