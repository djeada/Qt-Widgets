...
Description | Screenshot 
---|---
**[File Info](https://github.com/djeada/Qt-Widgets/tree/master/src/files/file_info)** - Display informations about files. Get list of files in a given directory and all its subdirectories. Use <code>QFileInfo</code> to get the file's name, size, and other data. | <img width=1000/></img> ![](https://github.com/djeada/Qt-Widgets/blob/master/resources/file_info.gif)
